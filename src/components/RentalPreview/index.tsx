    ...
    <AutoColumn gap="md" style={{ marginTop: '0.5rem' }}>
      <RowBetween style={{ marginBottom: '0.5rem' }}>
        <RowFixed>
          ...
          <ThemedText.Label ml="10px" fontSize="24px">
            {currency0?.symbol} / {currency1?.symbol} (Rental)
          </ThemedText.Label>
        </RowFixed>
      ...
      <AutoColumn gap="md">
        ...
        <LightCard padding="12px ">
          <AutoColumn gap="4px" justify="center">
            <ThemedText.Main fontSize="12px">
              <Trans>Rental Duration (Days)</Trans>
            </ThemedText.Main>
            <ThemedText.MediumHeader>{`${(rentalDurationSecs / 86400).toFixed(2)}`}</ThemedText.MediumHeader>
            <ThemedText.Main textAlign="center" fontSize="12px">
              <Trans>
