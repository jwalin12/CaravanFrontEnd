...
export const CARAVAN_ROUTER_ADDRESSES: AddressMap = {
  [SupportedChainId.RINKEBY]: '0xe864adEa9D49376f1fCa5cfb77bB895f47F58DA4',
}

export const CARAVAN_RENT_POOL_FACTORY_ADDRESSES: AddressMap = {
  [SupportedChainId.RINKEBY]: '0xa4af9e5CaBE87534B24eDeecEfB52159A33aa104',
}

export const CARAVAN_ESCROW_ADDRESSES: AddressMap = {
  [SupportedChainId.RINKEBY]: '0xB60160D52da04E5809397249425a688f85DF71BE',
}

export const CARAVAN_RENT_PLATFORM_ADDRESSES: AddressMap = {
  [SupportedChainId.RINKEBY]: '0x2076E63BCD4DcCEd94D214195F6DF096EA10DfB6',
}